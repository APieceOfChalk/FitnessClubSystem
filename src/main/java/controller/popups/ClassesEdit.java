...
public class ClassesEdit {
    ...
    public static void showEditView(Classes class_) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(ClassesEdit.class.getResource("/views/popups/ClassesEdit.fxml"));
            stage.setScene(new Scene(loader.load()));

            ClassesEdit controller = loader.getController();
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            myApiSession.updateClass(class_);
            name.getScene().getWindow().hide();
        }
    }
